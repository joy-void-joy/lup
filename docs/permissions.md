<!-- Generated from src/lup_template/devtools/harness/content/docs/permissions.py by `uv run lup-devtools harness generate all` — edit the source, not this file. -->
<!-- See docs/harness.md. -->
