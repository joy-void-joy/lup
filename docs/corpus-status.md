...
| # | What | Standing | Node |
| --- | --- | --- | --- |
|  | **[The first test-run artifact recorded a collection error, not a run](lup:roster-prompt-test-run-wrong)** | recorded | `roster-prompt-test-run-wrong` |

Generated from this repository's ledger: 8 node(s), 2 edge(s); 2 corpus:claim; 1 corpus:correction; newest record 2026-09-10T12:27:18.558762+00:00. Regenerate with `uv run lup-devtools ledger writeup`.
