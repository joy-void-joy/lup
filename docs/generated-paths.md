...
| `.claude/plugins/lup/agents/version-explorer.md` | lup.harness.content.agents.version_explorer |
...
| `.claude/plugins/lup/commands/create-investigator.md` | lup.harness.content.skills.create_investigator |
| `.claude/plugins/lup/commands/debug.md` | lup.harness.content.skills.debug |
| `.claude/plugins/lup/commands/delegate.md` | lup.harness.content.skills.delegate |
| `.claude/plugins/lup/commands/distill.md` | lup_template.harness.content.skills.distill |
| `.claude/plugins/lup/commands/fb-analyze.md` | lup.harness.content.skills.fb_analyze |
| `.claude/plugins/lup/commands/fb-implement.md` | lup.harness.content.skills.fb_implement |
| `.claude/plugins/lup/commands/fb-investigate.md` | lup.harness.content.skills.fb_investigate |
...
| `.claude/plugins/lup/commands/init.md` | lup_template.harness.content.skills.init |
| `.claude/plugins/lup/commands/install.md` | lup_template.harness.content.skills.install |
| `.claude/plugins/lup/commands/land.md` | lup.harness.content.skills.land |
| `.claude/plugins/lup/commands/merge.md` | lup.harness.content.skills.merge |
...
| `docs/architecture.md` | lup.harness.content.docs.architecture |
...
| `docs/library.md` | lup.harness.content.docs.library |
| `docs/native-capabilities.md` | lup.harness.content.docs.native_capabilities |
| `docs/orchestration.md` | lup.harness.content.docs.orchestration |
| `docs/patterns.md` | lup.harness.content.docs.patterns |
| `docs/permissions.md` | lup.harness.content.docs.permissions |
| `docs/platform-differentiation.md` | lup.harness.content.docs.platform_differentiation |
| `docs/quality-pipeline.md` | lup.harness.content.docs.quality_pipeline |
| `docs/resolver.md` | lup.harness.content.docs.resolver |
| `docs/runs.md` | lup.harness.content.docs.runs |
| `docs/self-improvement.md` | lup.harness.content.docs.self_improvement |
| `docs/supervisor.md` | lup.harness.content.docs.supervisor |
...
| `.codex/plugins/lup/skills/create-investigator/SKILL.md` | lup.harness.content.skills.create_investigator |
| `.codex/plugins/lup/skills/debug/SKILL.md` | lup.harness.content.skills.debug |
| `.codex/plugins/lup/skills/delegate/SKILL.md` | lup.harness.content.skills.delegate |
| `.codex/plugins/lup/skills/distill/SKILL.md` | lup_template.harness.content.skills.distill |
| `.codex/plugins/lup/skills/fb-analyze/SKILL.md` | lup.harness.content.skills.fb_analyze |
| `.codex/plugins/lup/skills/fb-implement/SKILL.md` | lup.harness.content.skills.fb_implement |
| `.codex/plugins/lup/skills/fb-investigate/SKILL.md` | lup.harness.content.skills.fb_investigate |
...
| `.codex/plugins/lup/skills/init/SKILL.md` | lup_template.harness.content.skills.init |
| `.codex/plugins/lup/skills/install/SKILL.md` | lup_template.harness.content.skills.install |
| `.codex/plugins/lup/skills/land/SKILL.md` | lup.harness.content.skills.land |
| `.codex/plugins/lup/skills/merge/SKILL.md` | lup.harness.content.skills.merge |
