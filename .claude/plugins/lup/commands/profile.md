...
argument-hint: '[list | use <name> | switch <name>]'
---
...
Where the verb is absent, Ask the user with the AskUserQuestion tool, offering concrete options plus a free-text choice: which profile to act on, and whether to select it for the next launch or switch this session onto it now. Where a verb names no profile, run `list`
