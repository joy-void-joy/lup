...
If no arguments provided, Ask the user with the AskUserQuestion tool, offering concrete options plus a free-text choice: which project to import from, and what pattern to import

If only a project name is provided (single word, no description), Ask the user with the AskUserQuestion tool, offering concrete options plus a free-text choice: what pattern to import from that project
