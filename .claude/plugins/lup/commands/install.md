...
3. **Slash commands**: which ones are generic (commit, rebase, close, clean-gone, meta, debug, refactor) vs lup-specific (init, feedback-loop, bump, update)
...
- **Generic commands**: commit, rebase, close, clean-gone, meta, debug, refactor, add-command, modify-command, merge-conflict
