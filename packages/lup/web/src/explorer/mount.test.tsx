...
const kinds: KindsView = {
  nodes: [
    { kind: "corpus:claim", name: "claim", summary: "Something a source asserts", fields: ["source", "quote"], placement: "committed" },
    { kind: "coordination:task", name: "task", summary: "Work somebody took on", fields: ["owner"], placement: "committed" },
  ],
  edges: [
    { kind: "corpus:rests_on", name: "rests_on", summary: "One claim depends on another", fields: [], placement: "" },
    { kind: "coordination:blocks", name: "blocks", summary: "One task waits on another", fields: [], placement: "" },
  ],
};
