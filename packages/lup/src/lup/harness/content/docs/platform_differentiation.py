...
"""
            ...
            *resolver_entry,
            models.TextPart(
                text=rf"""| Downstream template guidance | `.claude/plugins/lup/TEMPLATE_CLAUDE.md` from `content/template_claude.py` | `.codex/plugins/lup/TEMPLATE_AGENTS.md` from `content/template_codex.py` | Both flavors compose the portable sections in `content/template_sections.py`; only platform slices (guidance-file names, meta-agent naming, native edit and approval guidance, LSP vs CLI diagnostics, settings, communication idiom) differ. |
