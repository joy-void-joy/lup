...
(the declarations lup ships), `{layout.directory("harness", "content")}`
(the ones only this repository has), `{layout.path("harness", "catalog.py")}`
...
`{layout.path("harness", "content", "modules")}` for the ones only this
repository has. `{layout.path("harness", "content", "catalog.py")}` composes
