...
1. **Guidance** (`{layout.path("harness", "content", "guidance.py")}`, plus
...
2. **Template guidance** (`{layout.path("harness", "content", "template_sections.py")}`)
...
3. **All skill modules** (`{layout.directory("harness", "content", "skills")}*.py`,
...
4. **Canonical policy** (the library's `lup.policy` plus the `HookSet` in
   `{layout.path("harness", "catalog.py")}`; everything under """
                ),
