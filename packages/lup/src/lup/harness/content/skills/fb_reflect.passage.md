...
Read the full system prompt ({{ agent_prompts_py }}). Is it accumulating patches? Count conditional exceptions added since the last rewrite. If >3, flag for structural rewrite.
