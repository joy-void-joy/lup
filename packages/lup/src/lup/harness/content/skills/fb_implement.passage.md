...
Present the prioritized change list with its Bitter Lesson classification, then {{ approval }}
...
From capability gap analysis. Present the gap, the proposed approach, and the alternatives, then {{ ask }}
