...
- **Merge it from here** — the route when that branch's worktree is leased read-only, which a contained session does to every worktree that already existed when it started. `"""
            ),
            models.SkillInvocation(plugin="lup", skill="rebase"),
            models.TextPart(
