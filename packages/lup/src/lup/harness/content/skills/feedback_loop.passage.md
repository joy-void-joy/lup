...
When trace content is provided, run a focused single-trace deep analysis using the {{ fb_investigate_skill }} process (Steps 1-5) on the pasted content, then stop. Do not proceed to the full loop.
