...
The neutral :class:`~lup.coordination.refs.ActorRef` leaves ``kind`` open, because a
...
class MaterialQuestion(Question, frozen=True):
    ...
    are what any door reads, and live on :class:`~lup.coordination.questions.Question`.
