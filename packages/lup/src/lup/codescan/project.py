...
PACKAGE_ROOTS = {"lup", "lup_template"}
"""Import roots this repository publishes, as they appear on disk."""
...
def module_name(path: Path) -> str:
    ...
    roots = [
        ...
        if part in PACKAGE_ROOTS and (index == 0 or parts[index - 1] == "src")
    ]
    selected = parts[roots[-1] if roots else 0 :]
