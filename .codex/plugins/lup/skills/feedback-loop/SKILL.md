...
**If the user pasted trace content as an argument**: the arguments supplied with this skill invocation
...
Pass the arguments supplied with this skill invocation through. Ends with a gate — confirm targets before proceeding.
