...
Lesson table in the guidance), and 2-3 concrete examples of it in action. Then Ask the user directly, offering concrete options, and wait for the answer: whether that formulation is the right one
