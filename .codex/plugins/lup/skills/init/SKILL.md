...
diagnostic it prints. Then Ask the user directly, offering concrete options, and wait for the answer: which rule families this domain keeps, with retiring the anti-pattern family altogether as one answer. Offer the whole-family answer explicitly: a domain that does not want the
...
list does not mention. Read the declared roles, then Ask the user directly, offering concrete options, and wait for the answer: whether any root this domain adds needs a path role, and which.
...
rewrite, and worth skipping when it will not. Ask the user directly, offering concrete options, and wait for the answer: whether this domain declares an acceptance guard over its test roots
