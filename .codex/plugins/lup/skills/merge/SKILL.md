...
Show the conflict prediction and recommend a strategy, then Ask the user directly, offering concrete options, and wait for the answer: whether to run a standard merge and resolve in place, or apply the source branch manually file by file
