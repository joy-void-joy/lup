...
ANTI_PATTERN_ROWS: dict[str, list[AntiPatternRow]] = {
    ...
    ".py": [
        ...
        },
        {
            ...
            "pattern": "manager\\s*=\\s*[\"']script[\"']",
            "message": "A script package runs an unverified shell line at build time \u2014 prefer a distribution package, or a registry version whose integrity is checked before it lands",
            "context": "code",
            "refiner": "",
            "strength": "soft",
            "resolution": "",
