...
ANTI_PATTERN_ROWS = {
    ...
    ".py": [
        ...
        },
        {
            ...
            "message": "A declared `set` is usually better as a dict (keyed lookup) or a purpose-built structure. For a genuinely set-shaped value add `# lup: ignore[set-shape]`",
            "context": "code",
        },
        {
            "id": "empty-collection",
