...
def banner_notes(path: Path) -> list[str]:
    """Point every generated artifact at the guide, except the guide itself."""
    if path.as_posix() == GENERATED_GUIDE:
        return []
    return [f"See {GENERATED_GUIDE}."]
