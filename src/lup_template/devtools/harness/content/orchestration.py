...
DOCUMENT = models.PromptDocument(
    parts=[
        models.TextPart(
            text=r"""<!-- Generated from src/lup_template/devtools/harness/content/orchestration.py via `uv run lup-devtools harness generate all` — edit the source, not this file. See docs/generated-artifacts.md. -->
