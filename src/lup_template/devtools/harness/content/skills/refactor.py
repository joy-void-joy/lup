...
The argument is a **file or folder path**. If no path is provided, """
            ),
            models.AskUser(question="which file or folder to refactor"),
            models.TextPart(
                text=r"""
...
Read the project's guidance file (`"""
            ),
            models.NativePath(location="guidance_file"),
            models.TextPart(
                text=r"""`) to understand:
