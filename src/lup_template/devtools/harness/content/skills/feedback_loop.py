...
SKILL = models.Skill(
    ...
    tools=[
        "Bash(git:*, uv run lup-devtools:*, uv run lup:*), Read, Grep, Glob, Edit, Write, Agent, WebSearch, WebFetch, AskUserQuestion, Skill(lup:fb-status), Skill(lup:fb-investigate), Skill(lup:fb-analyze), Skill(lup:fb-reflect), Skill(lup:fb-implement)"
    ],
